...
Numer KSeF to unikalny identyfikator faktury nadawany przez system MF po pomyślnym zaewidencjonowaniu dokumentu. Numer ten jest wymagany m.in. przy wystawianiu faktury korygującej — korekta musi się odwoływać do numeru KSeF faktury pierwotnej. Bez prawidłowego numeru KSeF korekta zostanie odrzucona.
