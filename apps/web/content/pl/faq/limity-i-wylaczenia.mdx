...
Limit liczony jest jako łączna wartość sprzedaży w danym miesiącu, nie suma wystawionych faktur. Wlicza się sprzedaż opodatkowaną VAT oraz zwolnioną. Jeśli zbliżasz się do limitu lub nie jesteś pewien zasad, skonsultuj się z księgowym — przepisy w tym zakresie były zmieniane.

### Od kiedy obowiązuje mnie KSeF jeśli jestem poniżej limitu?

Jeśli twoja sprzedaż mieściła się poniżej progu uprawniającego do późniejszego terminu, obowiązek KSeF mógł objąć cię od 1 lipca 2026 roku lub od 1 stycznia 2027 roku w zależności od twojego statusu VAT. Daty te mogły ulec zmianom — zawsze weryfikuj aktualne przepisy na stronie ksef.podatki.gov.pl.
