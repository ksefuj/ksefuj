...
description: "KSeF od 1 kwietnia 2026 — kto musi, co się zmienia, jak się przygotować. Kompletny poradnik po obowiązkowym systemie e-faktur."
date: 2026-03-25
section: blog
locale: pl
...
<Info>
  Podatnicy zwolnieni z VAT (zarówno podmiotowo — ze względu na limit 240 000 PLN obrotu — jak i
  przedmiotowo) na razie nie mają obowiązku korzystania z KSeF. Obowiązek ten wchodzi w życie **1
  stycznia 2027 r.** (dla podatników, u których miesięczna wartość faktur nie przekracza 10 000 zł).
  Jeśli jesteś na zwolnieniu z VAT, możesz KSeF testować dobrowolnie już teraz.
</Info>
...
**Nie dotyczy** (do końca 2026 r.) podatników VAT zwolnionych — ani tych, którzy nie przekroczyli 240 000 PLN obrotu rocznie i wybrali zwolnienie podmiotowe, ani tych, którzy prowadzą działalność zwolnioną z VAT z mocy prawa (art. 43 ust. 1 ustawy o VAT). Obowiązek KSeF dla tej grupy wchodzi w życie **1 stycznia 2027 r.**

### Wyjątek: bardzo małe obroty

Jeśli Twoja miesięczna sprzedaż nie przekracza 10 000 PLN, przepisy przewidują tymczasowe zwolnienie z obowiązku wystawiania faktur przez KSeF — **do 31 grudnia 2026 r.** Po tym terminie zwolnienie wygasa i obowiązek KSeF obejmie również tę grupę. Szczegóły omówiliśmy osobno — [przeczytaj artykuł o limicie 10 000 zł](/blog/ksef-limit-10000-zl).
...
Najczęstsze błędy w plikach KSeF opisaliśmy w osobnym artykule: [Najczęstsze błędy walidacji FA(3)](/blog/najczestsze-bledy-walidacji-fa3).
...
- faktury związane z dostawami i usługami poza terytorium Polski — **uwaga: faktura nadal musi być wystawiona w KSeF**, ale nabywca zagraniczny otrzymuje ją poza systemem, w sposób uzgodniony (np. PDF z kodem QR). Dotyczy to m.in. WDT i eksportu,
...
Szczegółowy poradnik po trybach pracy KSeF znajdziesz w naszym dziale [poradników](/guides).
...
Ministerstwo Finansów udostępnia środowisko testowe KSeF 2.0 pod adresem `https://ap-test.ksef.mf.gov.pl/web/`. Możesz tam wysyłać faktury z fikcyjnymi danymi i sprawdzać, jak system reaguje — bez żadnych konsekwencji prawnych.
