...
interface ContributeFooterProps {
  ...
  /** Override the computed edit URL (e.g. to link to a directory instead of a file). */
  editUrl?: string;
}
...
> = {
  ...
  uk: {
    ...
    body: "ksefuj — це спільний проєкт із ліцензією Apache 2.0. Якщо помітиш помилку або захочеш запропонувати покращення — можеш відредагувати цю статтю прямо на GitHub. Особливо вітаємо покращення перекладу.",
    editLabel: "Редагувати на GitHub",
    issueLabel: "Повідомити про проблему",
    translationNote:
      "Покращення перекладу цієї статті особливо вітаються — допоможи зробити KSeF доступнішим для україномовних користувачів.",
  },
};
...
export function ContributeFooter({
  ...
  const editUrl =
    editUrlOverride ?? `${REPO}/edit/main/apps/web/content/${fileLocale}/${section}/${slug}.mdx`;
        ...
        <div className="min-w-0 flex-1 space-y-3">
          ...
          <div className="flex flex-wrap gap-3 pt-1">
            <a
              ...
              onClick={() => amplitude.track("content_edit_on_github", { locale, section, slug })}
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              onClick={() => amplitude.track("content_issue_opened", { locale, section, slug })}
